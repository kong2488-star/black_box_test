...
|---|---|---|
| Coarse | `coarse_probe.py:PROMPT` (+ EVENT_DEFINITIONS·힌트 치환) | `86d529856262` |
| Fine 공통+델타 | `fine_probe.py:COMMON_BLOCK` + `DELTAS` | `a9b72e476fc3` (fine-p1) |
...
**primitive 이름 예시:** `RED_SIGNAL`, `GREEN_SIGNAL`, `STOP_LINE`, `TARGET_VEHICLE`
